...
public class ServiceAPI {
    ...
    public void changeMail(Professeur professeur, String mail) throws JSONException, IOException {
        JSONObject jsonLogin = new JSONObject();
        jsonLogin.put("email", mail);
        jsonLogin.put("idContact", professeur.getContact().getIdContact());
        StringEntity se = new StringEntity(jsonLogin.toString());
        this.prepareHttpPost("/rest/api/contact/changeMail", se);
        httpClient = new DefaultHttpClient(this.getHttpParams());
        response = httpClient.execute(httpPost);
    }
/*
    public void changePassword(Professeur professeur, String password) throws JSONException, IOException {
        JSONObject jsonLogin = new JSONObject();
        jsonLogin.put("passwordChange", password);
        jsonLogin.put("idContact", professeur.getContact().getIdContact());
        StringEntity se = new StringEntity(jsonLogin.toString());
        this.prepareHttpPost("/rest/api/contact/changePassword", se);
        httpClient = new DefaultHttpClient(this.getHttpParams());
        response = httpClient.execute(httpPost);
    }
*/
